        ...
        <form action="{{ route('update-profile') }}" method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            <div class="row p-0 align-items-center">
              <div class="col-md-3">
                @if (!$data->image)
                  <img src="{{ asset('storage/dummy/profile-dummy-2.jpg') }}" class="img-fluid rounded" alt="prfile-image"
                    id="imgPreview">
                  <p class="text-danger mb-md-0" id="abnormal">*your image is not set</p>
                @else
                  <img src="{{ asset('storage/profile_images/' . $data->image) }}" class="img-fluid rounded"
                    alt="prfoile-image" id="imgPreview">
                @endif
              </div>
              <div class="col-md-9">
